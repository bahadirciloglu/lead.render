...
DATA_QUALITY_STANDARDS = {
    "company_info": {
        "required_fields": [
            "name", "industry", "location", "company_size", 
            "funding_stage", "founder", "funder", "website"
        ],
        "validation_rules": {
    ...
    "search_filters": {
        ...
        "industry": [
            "AI & Machine Learning", "Fintech", "Healthtech", 
            "E-commerce", "SaaS", "Biotech", "Clean Energy"
        ],
        "company_size": ["1-10", "11-50", "51-200", "201-1000", "1000+"],
        "funding_stage": [
            "Pre-seed/Seed", "Series A", "Series B", 
            "Series C+", "IPO", "Acquired"
        ]
    }
}

...
class SimpleAuthService:
    ...
    def register_user(self, email: str, username: str, password: str, full_name: str = None) -> Dict[str, Any]:
    ...
    def increment_api_calls(self, user_id: str):
        ...
        users = self._load_users()
        if user_id in users:
            users[user_id]["api_calls_count"] = users[user_id].get("api_calls_count", 0) + 1
    ...
    def validate_session(self, access_token: str) -> Optional[Dict[str, Any]]:
        ...
        for session_id, session_data in sessions.items():
            if (session_data.get("access_token") == access_token and 
                session_data.get("is_active") == True):
    ...
    def change_password(self, user_id: str, current_password: str, new_password: str) -> bool:
        ...
        if not self.verify_password(current_password, user_data.get("hashed_password", "")):
            return False
    ...
    def update_user_profile(self, user_id: str, **kwargs) -> bool:
        ...
        updatable_fields = ["full_name", "company", "role", "phone", "avatar_url", "is_active", "is_admin"]
    ...
    def get_user_stats(self) -> dict:
        ...
        total_sessions = len([s for s in sessions.values() if s.get("is_active", False)])
    ...
    def search_users(self, query: str, current_user_id: str = None) -> list:
        ...
        for user_id, user_data in users.items():
            ...
            if not current_user_id or user_data.get("is_admin", False):
                if (query_lower in user_data.get("username", "").lower() or

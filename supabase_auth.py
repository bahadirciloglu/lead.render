...
class SupabaseAuthService:
    ...
    def sign_up(self, email: str, password: str, user_data: Dict) -> Dict:
        ...
        try:
            ...
            auth_response = self.auth.sign_up({"email": email, "password": password})
    ...
    def create_user_admin(
        self, email: str, password: str, is_admin: bool = False, is_active: bool = True
    ) -> Optional[Dict]:
    ...
    def add_existing_user_to_db(
        self, email: str, user_id: str, is_admin: bool = False, is_active: bool = True
    ) -> Optional[Dict]:
    ...
    def update_user_last_login(self, user_id: str) -> bool:
        ...
        try:
            self.db.update_user(user_id, {"last_login": datetime.utcnow().isoformat()})
            return True
        except Exception as e:
    ...
    def sign_in(self, email: str, password: str) -> Dict:
        ...
        try:
            ...
            if auth_response.user:
                ...
                self.db.update_user(
                    auth_response.user.id, {"last_login": datetime.utcnow().isoformat()}
                )
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    print(
                        f"❌ Problematic part: {payload_str[max(0, json_error.pos-20):json_error.pos+20]}"
                    )
